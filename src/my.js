...
export default class my {
  ...
  static getSystemInfoSync(my_object) {
    return (wx.getSystemInfoSync(my_object))
  }
  ...
  static getUpdateManager(my_object) {
    return wx.getUpdateManager(my_object)
  }

  static getLaunchOptionsSync(my_object) {
    return wx.getLaunchOptionsSync(my_object)
  }

  static offPageNotFound(my_object) {
    return wx.offPageNotFound(my_object)
  }

  static onPageNotFound(my_object) {
    return wx.onPageNotFound(my_object)
  }

  static offError(my_object) {
    return wx.offError(my_object)
  }

  static onError(my_object) {
    return wx.onError(my_object)
  }

  static offAppShow(my_object) {
    return wx.offAppShow(my_object)
  }

  static onAppShow(my_object) {
    return wx.onAppShow(my_object)
  }

  static offAppHide(my_object) {
    return wx.offAppHide(my_object)
  }

  static onAppHide(my_object) {
    return wx.onAppHide(my_object)
  }

  static setEnableDebug(my_object) {
    return wx.setEnableDebug(my_object)
  }

  static getLogManager(my_object) {
    return wx.getLogManager(my_object)
  }

  static rsa() {
    return /* wx.esa(my_object) */ console.warn('is not support')
  }
  ...
  static canvasPutImageData(my_object) {
    return wx.canvasPutImageData(my_object)
  }

  static canvasGetImageData(my_object) {
    return wx.canvasGetImageData(my_object)
  }

  // //////////// Device //////////////////
  static onBeaconServiceChange(my_object) {
    return wx.onBeaconServiceChange(my_object)
  }

  static onBeaconUpdate(my_object) {
    return wx.onBeaconUpdate(my_object)
  }

  static getBeacons(my_object) {
    return wx.getBeacons(my_object)
  }

  static stopBeaconDiscovery(my_object) {
    return wx.stopBeaconDiscovery(my_object)
  }

  static startBeaconDiscovery(my_object) {
    return wx.startBeaconDiscovery(my_object)
  }

  static stopWifi(my_object) {
    return wx.stopWifi(my_object)
  }

  static startWifi(my_object) {
    return wx.startWifi(my_object)
  }

  static setWifiList(my_object) {
    return wx.setWifiList(my_object)
  }

  static onWifiConnected(my_object) {
    return wx.onWifiConnected(my_object)
  }

  static onGetWifiList(my_object) {
    return wx.onGetWifiList(my_object)
  }

  static getWifiList(my_object) {
    return wx.getWifiList(my_object)
  }

  static getConnectedWifi(my_object) {
    return wx.getConnectedWifi(my_object)
  }

  static connectWifi(my_object) {
    return wx.connectWifi(my_object)
  }

  static setNavigationBar(my_object) {
    return wx.setNavigationBarTitle(my_object)
  }
  ...
  static getBatteryInfoSync(my_object) {
    return wx.getBatteryInfoSync(my_object)
  }
  ...
  //
  static onDeviceMotionChange(my_object) {
    return wx.onDeviceMotionChange(my_object)
  }

  static stopDeviceMotionListening(my_object) {
    return wx.stopDeviceMotionListening(my_object)
  }

  static startDeviceMotionListening(my_object) {
    return wx.startDeviceMotionListening(my_object)
  }
  ...
  static _network(wx_res) {
    ...
    return {
      isConnected: wx_res.networkAvailable,
  ...
  //
  static onMemoryWarning(my_object) {
    return wx.onMemoryWarning(my_object)
  }

  static offMemoryWarning(callback) {
    return wx.offMemoryWarning(callback)
  }

  //
  static writeBLECharacteristicValue(my_object) {
    return wx.writeBLECharacteristicValue(my_object)
  }

  static readBLECharacteristicValue(my_object) {
    return wx.readBLECharacteristicValue(my_object)
  }

  static onBLEConnectionStateChange(my_object) {
    return wx.onBLEConnectionStateChange(my_object)
  }

  static onBLECharacteristicValueChange(my_object) {
    return wx.onBLECharacteristicValueChange(my_object)
  }

  static notifyBLECharacteristicValueChange(my_object) {
    return wx.notifyBLECharacteristicValueChange(my_object)
  }

  static getBLEDeviceServices(my_object) {
    return wx.getBLEDeviceServices(my_object)
  }

  static getBLEDeviceCharacteristics(my_object) {
    return wx.getBLEDeviceCharacteristics(my_object)
  }

  static createBLEConnection(my_object) {
    return wx.createBLEConnection(my_object)
  }

  static closeBLEConnection(my_object) {
    return wx.closeBLEConnection(my_object)
  }

  static offBLECharacteristicValueChange(callback) {
    return wx.offBLECharacteristicValueChange(callback)
  }

  static offBluetoothAdapterStateChange(callback) {
    return wx.offBluetoothAdapterStateChange(callback)
  }

  static onBLEConnectionStateChanged(callback) {
    return wx.onBLEConnectionStateChanged(callback)
  }

  static offBLEConnectionStateChanged(callback) {
    return wx.offBLEConnectionStateChange(callback)
  }

  //
  static stopBluetoothDevicesDiscovery(my_object) {
    const wx_object = {}
    const key = Object.keys(my_object)
    switch (key) {
      case 'success':
        break
      case 'fail':
  ...
  static onBluetoothDeviceFound(my_object) {
    return wx.onBluetoothDeviceFound(my_object)
  }

  static onBluetoothAdapterStateChange(my_object) {
    return wx.onBluetoothAdapterStateChange(my_object)
  }

  static getConnectedBluetoothDevices(my_object) {
    return wx.getConnectedBluetoothDevices(my_object)
  }
  ...
  static getBluetoothAdapterState(my_object) {
    return wx.getBluetoothAdapterState(my_object)
  }

  static closeBluetoothAdapter(my_object) {
    return wx.closeBluetoothAdapter(my_object)
  }
  ...
  static stopHCE(my_object) {
    return wx.stopHCE(my_object)
  }

  static startHCE(my_object) {
    return wx.startHCE(my_object)
  }

  static sendHCEMessage(my_object) {
    return wx.sendHCEMessage(my_object)
  }

  static onHCEMessage(my_object) {
    return wx.onHCEMessage(my_object)
  }

  static getHCEState(my_object) {
    return wx.getHCEState(my_object)
  }
  ...
  static setKeepScreenOn(my_object) {
    return wx.setKeepScreenOn(my_object)
  }

  static onUserCaptureScreen(my_object) {
    return wx.onUserCaptureScreen(my_object)
  }
  ...
  static watchShake() {
    return /* wx.watchShake */ console.warn('is not support')
  }

  static getServerTime() {
    return /* wx.getServerTime */ console.warn('is not support')
  }
  ...
  // ///////////////// Ext //////////////
  static getExtConfigSync(my_object) {
    return wx.getExtConfigSync(my_object)
  }

  static getExtConfig(my_object) {
    return wx.getExtConfig(my_object)
  }

  // ////////////////// File //////////
  static getFileSystemManager(my_object) {
    return wx.getFileSystemManager(my_object)
  }
  ...
  static removeSavedFile(my_object) {
    return wx.removeSavedFile(my_object)
  }

  static getSavedFileInfo(my_object) {
    return wx.getSavedFileInfo(my_object)
  }

  static getSavedFileList(my_object) {
    return wx.getSavedFileList(my_object)
  }

  static openDocument(my_object) {
    return wx.openDocument(my_object)
  }
  ...
  static saveFile(my_object) {
    ...
    const wx_object = {
      ...
      success(wx_res) {
        const my_res = {
          savedFilePath: wx_res.savedFilePath
        }
        if (my_success) {
          my_success(my_res)
        }
  ...
  static openLocation(my_object) {
    return wx.openLocation(my_object)
  }

  static getLocation(my_object) {
    return wx.getLocation(my_object)
  }

  static chooseLocation(my_object) {
    return wx.chooseLocation(my_object)
  }
  ...
  static compressImage(my_object) {
    return wx.compressImage(my_object)
  }

  static saveImage(my_object) {
    return wx.saveImageToPhotosAlbum(my_object)
  }

  static getImageInfo(my_object) {
    return wx.getImageInfo(my_object)
  }

  static previewImage(my_object) {
    return wx.previewImage(my_object)
  }
  ...
  static saveVideoToPhotosAlbum(my_object) {
    return wx.saveVideoToPhotosAlbum(my_object)
  }

  static chooseVideo(my_object) {
    return wx.chooseVideo(my_object)
  }

  static stopVoice(my_object) {
    return wx.stopVoice(my_object)
  }

  static pauseVoice(my_object) {
    return wx.pauseVoice(my_object)
  }

  static playVoice(my_object) {
    return wx.playVoice(my_object)
  }

  static setInnerAudioOption(my_object) {
    return wx.setInnerAudioOption(my_object)
  }

  static getAvailableAudioSources(my_object) {
    return wx.getAvailableAudioSources(my_object)
  }

  static createInnerAudioContext(my_object) {
    return wx.createInnerAudioContext(my_object)
  }

  static createAudioContext(my_object) {
    return wx.createAudioContext(my_object)
  }

  static onBackgroundAudioStop(my_object) {
    return wx.onBackgroundAudioStop(my_object)
  }

  static onBackgroundAudioPause(my_object) {
    return wx.onBackgroundAudioPause(my_object)
  }

  static onBackgroundAudioPlay(my_object) {
    return wx.onBackgroundAudioPlay(my_object)
  }

  static stopBackgroundAudio(my_object) {
    return wx.stopBackgroundAudio(my_object)
  }

  static seekBackgroundAudio(my_object) {
    return wx.seekBackgroundAudio(my_object)
  }

  static pauseBackgroundAudio(my_object) {
    return wx.pauseBackgroundAudio(my_object)
  }

  static playBackgroundAudio(my_object) {
    return wx.playBackgroundAudio(my_object)
  }

  static getBackgroundAudioPlayerState(my_object) {
    return wx.getBackgroundAudioPlayerState(my_object)
  }

  static getBackgroundAudioManager(my_object) {
    return wx.getBackgroundAudioManager(my_object)
  }

  static createLivePusherContext(my_object) {
    return wx.createLivePusherContext(my_object)
  }

  static startRecord(my_object) {
    return wx.startRecord(my_object)
  }

  static stopRecord(my_object) {
    return wx.stopRecord(my_object)
  }

  static getRecorderManager(my_object) {
    return wx.getRecorderManager(my_object)
  }
  ...
  static connectSocket(my_object) {
    return wx.connectSocket(my_object)
  }

  static onSocketError(my_object) {
    return wx.onSocketError(my_object)
  }

  static onSocketMessage(my_object) {
    return wx.onSocketMessage(my_object)
  }

  static onSocketClose(my_object) {
    return wx.onSocketClose(my_object)
  }

  static onSocketOpen(my_object) {
    return wx.onSocketOpen(my_object)
  }

  static sendSocketMessage(my_object) {
    return wx.sendSocketMessage(my_object)
  }

  static closeSocket(my_object) {
    return wx.closeSocket(my_object)
  }

  static offLocalServiceResolveFail(my_object) {
    return wx.offLocalServiceResolveFail(my_object)
  }

  static onLocalServiceResolveFail(my_object) {
    return wx.onLocalServiceResolveFail(my_object)
  }

  static offLocalServiceDiscoveryStop(my_object) {
    return wx.offLocalServiceDiscoveryStop(my_object)
  }

  static onLocalServiceDiscoveryStop(my_object) {
    return wx.onLocalServiceDiscoveryStop(my_object)
  }

  static offLocalServiceLost(my_object) {
    return wx.offLocalServiceLost(my_object)
  }

  static onLocalServiceLost(my_object) {
    return wx.onLocalServiceLost(my_object)
  }

  static offLocalServiceFound(my_object) {
    return wx.offLocalServiceFound(my_object)
  }

  static onLocalServiceFound(my_object) {
    return wx.onLocalServiceFound(my_object)
  }

  static stopLocalServiceDiscovery(my_object) {
    return wx.stopLocalServiceDiscovery(my_object)
  }

  static startLocalServiceDiscovery(my_object) {
    return wx.startLocalServiceDiscovery(my_object)
  }
  ...
  static navigateToMiniProgram(my_object) {
    return wx.navigateToMiniProgram(my_object)
  }

  static navigateBackMiniProgram(my_object) {
    return wx.navigateBackMiniProgram(my_object)
  }

  static getAccountInfoSync(my_object) {
    return wx.getAccountInfoSync(my_object)
  }

  // static reportMonitor(my_object) { return wx.reportMonitor(my_object) }

  static reportAnalytics(my_object) {
    return wx.reportAnalytics(my_object)
  }
  ...
  static authorize(my_object) {
    return wx.authorize(my_object)
  }

  static openSetting(my_object) {
    return wx.openSetting(my_object)
  }

  static getSetting(my_object) {
    return wx.getSetting(my_object)
  }

  static chooseAddress(my_object) {
    return wx.chooseAddress(my_object)
  }
  ...
  static chooseInvoiceTitle(my_object) {
    return wx.chooseInvoiceTitle(my_object)
  }

  static chooseInvoice(my_object) {
    return wx.chooseInvoice(my_object)
  }

  static startSoterAuthentication(my_object) {
    return wx.startSoterAuthentication(my_object)
  }

  static checkIsSupportSoterAuthentication(my_object) {
    return wx.checkIsSupportSoterAuthentication(my_object)
  }

  static checkIsSoterEnrolledInDevice(my_object) {
    return wx.checkIsSoterEnrolledInDevice(my_object)
  }

  static getWeRunData(my_object) {
    return wx.getWeRunData(my_object)
  }
  ...
  static updateShareMenu(my_object) {
    return wx.updateShareMenu(my_object)
  }
  ...
  static hideShareMenu(my_object) {
    return wx.hideShareMenu(my_object)
  }

  static getShareInfo(my_object) {
    return wx.getShareInfo(my_object)
  }

  // ///////////// Storage //////////////
  static getStorageInfoSync(my_object) {
    return wx.getStorageInfoSync(my_object)
  }

  static getStorageInfo(my_object) {
    return wx.getStorageInfo(my_object)
  }

  static clearStorageSync(my_object) {
    wx.clearStorageSync(my_object)
    return {}
  }

  static clearStorage(my_object) {
    return wx.clearStorage(my_object)
  }

  static removeStorageSync(my_object) {
    wx.removeStorageSync(my_object.key)
    return {}
  }

  static removeStorage(my_object) {
    return wx.removeStorage(my_object)
  }

  static setStorageSync(my_object) {
    wx.setStorageSync(my_object.key, my_object.data)
    return {}
  }

  static setStorage(my_object) {
    return wx.setStorage(my_object)
  }

  static getStorageSync(my_object) {
    return {
      data: wx.getStorageSync(my_object.key)
    }
  }

  static getStorage(my_object) {
    return wx.getStorage(my_object)
  }
  ...
  static hideLoading(my_object) {
    return wx.hideLoading(my_object)
  }
  ...
  static SDKVersion() {
    return console.warn('不支持此功能')
  }

  static hideToast(my_object) {
    return wx.hideToast(my_object)
  }
  ...
  static alert(my_object) {
    return wx.showModal(my_object)
  }

  static setNavigationBarColor(my_object) {
    return wx.setNavigationBarColor(my_object)
  }
  ...
  static setBackgroundTextStyle(my_object) {
    return wx.setBackgroundTextStyle(my_object)
  }

  static setBackgroundColor(my_object) {
    return wx.setBackgroundColor(my_object)
  }

  static setTabBarItem(my_object) {
    return wx.setTabBarItem(my_object)
  }

  static setTabBarStyle(my_object) {
    return wx.setTabBarStyle(my_object)
  }

  static hideTabBar(my_object) {
    return wx.hideTabBar(my_object)
  }

  static showTabBar(my_object) {
    return wx.showTabBar(my_object)
  }

  static hideTabBarRedDot(my_object) {
    return wx.hideTabBarRedDot(my_object)
  }

  static showTabBarRedDot(my_object) {
    return wx.showTabBarRedDot(my_object)
  }

  static removeTabBarBadge(my_object) {
    return wx.removeTabBarBadge(my_object)
  }

  static setTabBarBadge(my_object) {
    return wx.setTabBarBadge(my_object)
  }

  static loadFontFace(my_object) {
    return wx.loadFontFace(my_object)
  }
  ...
  static pageScrollTo(my_object) {
    return wx.pageScrollTo(my_object)
  }

  static setTopBarText(my_object) {
    return wx.setTopBarText(my_object)
  }

  static nextTick(my_object) {
    return wx.nextTick(my_object)
  }

  static getMenuButtonBoundingClientRect(my_object) {
    return wx.getMenuButtonBoundingClientRect(my_object)
  }

  static offWindowResize(my_object) {
    return wx.offWindowResize(my_object)
  }

  static onWindowResize(my_object) {
    return wx.onWindowResize(my_object)
  }

  // //////////// Worker ///////////////
  static createWorker(my_object) {
    return wx.createWorker(my_object)
  }

  // //////////// WXML ///////////////
  static createSelectorQuery(my_object) {
    return wx.createSelectorQuery(my_object)
  }

  static createIntersectionObserver(my_object) {
    return wx.createIntersectionObserver(my_object)
  }

  // ///////////////////////////////////
  static hideKeyboard(my_object) {
    return wx.hideKeyboard(my_object)
  }
